...
// $Id: com_team_chat_msg_input.php,v 1.4 2002/11/04 22:20:03 thomas Exp $
...
function gen_form($file1, $file2, $file3, $file4, $offset) {
	...
	if(!$_POST['obj_id']) {
	    ...
	    display_team_chat_messages($file1, $file2, $offset);
...
function display_team_chat_messages($file1, $file2, $offset) {
    ...
    $query = "select
              ...
              from rct_chat_log_teams where team_id='" . $_POST['obj_id'] . "' 
    ...
    if(0 == $numrows) {
        ...
        disp_msg("There are not team chat messages for this team");
	$db->close();
        unset($db);
        return;
    }
	...
	if($i % 2) {
	    ...
	    gen_team_chat_msg_delete($myrow, $file1, $file2);
...
function gen_team_chat_msg_delete($row, $file1, $file2) {
