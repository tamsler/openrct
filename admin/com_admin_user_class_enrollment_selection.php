...
// $Id: com_admin_user_class_enrollment_selection.php,v 1.1 2002/10/31 20:48:45 thomas Exp $
...
function gen_form($file1, $file2, $query) {
	...
	gen_html_header("User --> Class Enrollment:");
	...
	printf("</select>
            ...
            <td>
            &nbsp;
            <input type=submit value='List Class Enrollment\nFor Selected User'>
