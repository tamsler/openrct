...
// $Id: admin_tasks.php,v 1.44 2003/06/20 17:23:16 thomas Exp $
...
function display_general_admin_tasks() {
    ...
    printf("<br>
	   ...
	   <form method='post' action='add_user_input.php'>
	   ...
	   <form method='post' action='add_multiple_users_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Multiple Users (Form)'>
	   </form>

	   <form method='post' action='add_multiple_users_textarea_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Multiple Users (Textarea)'>
	   </form>

	   <form method='post' action='add_class_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Single Class'>
	   </form>

	   <form method='post' action='add_team_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Single Team'>
	   </form>

           <form method='post' action='add_course_content_input.php'>
           <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   ...
	   <form method='post' action='enroll_user_class_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='User In Class'>
	   </form>

	   <form method='post' action='enroll_user_team_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='User In Team'>
	   </form>

           <form method='post' action='enroll_user_class_team_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   ...
	   <!-- ADMINISTRATE -->
	   <td bgcolor=" . TB_COLOR_1 . " valign=top>
	   <form method='post' action='admin_users_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Users'>
	   </form>

	   <form method='post' action='admin_classes_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Classes'>
	   </form>

	   <form method='post' action='admin_teams_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Teams'>
	   </form>

           <form method='post' action='all_course_content_input.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Course Content'>
	   </form>

           <form method='post' action='admin_user_class_enrollment_selection.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='User In Class Enrollment'>
	   </form>

           <form method='post' action='admin_user_team_enrollment_selection.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
...
function display_module_admin_tasks() {
    ...
    printf("<br>
	   ...
	   <!-- CHAT -->
	   <td bgcolor=". TB_COLOR_1 . " valign=top>
	   <form method='post' action='all_chat_msg_input.php?assembly_type=" . TEAM . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='All Team Chat Messages'>
	   </form>

           <form method='post' action='all_chat_msg_input.php?assembly_type=" . GROUP . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='All Group Chat Messages'>
	   </form>

	   <form method='post' action='user_chat_msg_selection.php?assembly_type=" . TEAM . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='User Team Chat Messages'>
	   </form>

	   <form method='post' action='user_chat_msg_selection.php?assembly_type=" . GROUP . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='User Group Chat Messages'>
	   </form>

	   <form method='post' action='class_chat_msg_selection.php?assembly_type=" . TEAM . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Class Team Chat Messages'>
	   </form>

	   <form method='post' action='class_chat_msg_selection.php?assembly_type=" . GROUP . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Class Group Chat Messages'>
	   </form>

           <form method='post' action='team_chat_msg_selection.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='Team Chat Messages'>
	   </form>

           <form method='post' action='group_chat_msg_selection.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   ...
	   <!-- TEXTPAD -->
	   <td bgcolor=" . TB_COLOR_2 . " valign=top>
           <form method='post' action='all_tp_input.php?assembly_type=" . TEAM . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='All Team Textpads'>
	   </form>

           <form method='post' action='all_tp_input.php?assembly_type=" . GROUP . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   ...
	   <!-- SOUND -->
	   <td bgcolor=" . TB_COLOR_1 . " valign=top>
           <form method='post' action='all_sound_input.php?assembly_type=" . TEAM . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='All Team Sound Messages'>
	   </form>

           <form method='post' action='all_sound_input.php?assembly_type=" . GROUP . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   ...
	   <!-- File Transfer -->
	   <td bgcolor=" . TB_COLOR_1 . " valign=top>
           <form method='post' action='all_ftp_input.php?assembly_type=" . TEAM . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='All Team FTP Files'>
	   </form>

           <form method='post' action='all_ftp_input.php?assembly_type=" . GROUP . "'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
...
// Display DB Transactions
function display_db_transactions() {

    printf("<br>
	   <table border=1 cellspacing=1 cellpadding=5>

           <tr>
           <th bgcolor=" . TB_COLOR_1 . " ><b><font face='arial' color=" . TB_HEAD_1 . " >DB Transactions:</font></b></th>
	   </tr>
	   ...
	   <!-- DB Transactoins-->
	   <td bgcolor=" . TB_COLOR_1 . " valign=top>
	   <form method='post' action='all_db_transactions.php'>
	   <input type='hidden' name='access' value='" . $_POST['access'] . "'>
	   <input type='hidden' name='access_id' value='" . $_POST['access_id'] . "'>
	   <input style='width:15em' type='submit' value='All DB Transactions'>
	   </form>
	   </td>
