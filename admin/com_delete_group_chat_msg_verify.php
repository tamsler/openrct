...
// $Id: com_delete_group_chat_msg_verify.php,v 1.2 2002/11/01 22:35:12 thomas Exp $
...
function gen_form($file1) {
	...
	gen_html_header("Verify Delete Group Chat Message:");
...
function delete_another_chat_message() {
    ...
    printf("
            <form method='post' action='" . $_POST['form_name'] . "?assembly_type=" . GROUP . "'>
...
function delete_chat_message() {
    ...
    // Query
    $query = "DELETE FROM rct_chat_log_groups WHERE chat_id='" . $_POST['chat_id'] . "'";
	...
	disp_msg("Deleted group chat messages successfully in DB.");
    }
