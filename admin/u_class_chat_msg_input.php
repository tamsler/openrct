...
// $Id: u_class_chat_msg_input.php,v 1.1 2002/07/05 20:02:31 thomas Exp $
...
if(page_access_granted($_POST['access_id'], $_POST['access'])) {
	...
	display_class_team_chat_messages();

	echo("<br>");

	disp_simple_msg("List Class Group Chat Messages:");

	display_class_group_chat_messages();
...
function display_class_group_chat_messages() {

    // Query
    $query = "select * from rct_chat_log_groups where
              class_id='" . $_POST['obj_id'] . "' and
...
function display_class_team_chat_messages() {
...
function go_back() {
    ...
    printf("<form method='post' action='u_class_chat_msg_selection.php'>
