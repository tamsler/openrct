// $Id: ArchiveFtpDataTimeRange.java,v 1.4 2003/05/08 20:09:03 thomas Exp $
...
public class ArchiveFtpDataTimeRange extends AbstractTableModel implements
		Const {
	...
	// Constructor
	public ArchiveFtpDataTimeRange(String className, String teamName,
	...
	private void populateData() {
		...
		if (ARCH_SEL_TODAY == selectionType_) {
			...
			try {
				...
				TeamModule.getFtpArchiveTimeRange(className_, teamName_,
						fromDate, toDate, ftpSeq_);
