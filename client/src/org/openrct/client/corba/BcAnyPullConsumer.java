// $Id: BcAnyPullConsumer.java,v 1.4 2003/05/08 19:31:42 thomas Exp $
...
public class BcAnyPullConsumer implements Const {

	private ProxyPullSupplier proxyPullSupplier_ = null;

	// Constructor
	public BcAnyPullConsumer(EventChannel ec) {
		...
		Thread bcAnyPullConsumerThread = new Thread(new Runnable() {
